...
<html data-wf-site="548ef97187202bb925402835" data-wf-page="548ef97187202bb925402836">
<head>
  <meta charset="utf-8">
  <title>Spris Pizza</title>
  ...
  <script>
    WebFont.load({
      google: {
        families: ["Droid Sans:400,700", "Lobster:400,700"]
      }
    });
  </script>
...
<body>
  <div class="w-container wraper">
    <div class="w-row main-row">
      <div class="w-col w-col-2 w-col-stack w-hidden-medium w-hidden-small w-hidden-tiny columnalogo">
        <a class="w-inline-block" href="index.php"><img class="img-logovert link-img" src="images/panel-1-logo.jpg" alt="Spris Pizza">
        </a>
      </div>
      <div class="w-col w-col-8 w-col-stack columnacontenido">
        ...
        <div class="w-row columna-en3-1">
          ...
          <!-- Locations -->
          <div class="w-col w-col-4 w-col-small-4 col2">
          ...
          <!-- Menu -->
          <div class="w-col w-col-4 w-col-small-4 col3">
        ...
        <!-- Franchise -->
        <div class="w-row columna-en3-2">
          <div class="w-col w-col-4 w-col-small-4 col4">
